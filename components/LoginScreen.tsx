    ...
    <div className="min-h-dvh bg-[#050B14] flex flex-col items-center justify-center p-6 pt-safe font-sans relative overflow-hidden selection:bg-cyan-500/30">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-normal text-white tracking-tighter mb-2 flex items-center justify-center gap-3" style={{ fontFamily: 'Ghanes.ttf, sans-serif' }}>
