...
export function ChatBox({ athleteId, athletePhone, athleteName, inline = false }: ChatBoxProps) {
  ...
  return (
    <div className={inline ? "w-full h-full flex flex-col overflow-hidden bg-[#050B14]" : "fixed bottom-6 right-6 w-[350px] h-[500px] bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden"}>
