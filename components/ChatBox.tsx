...
export function ChatBox({ athleteId, athletePhone, athleteName }: ChatBoxProps) {
  ...
  const cleanPhone = athletePhone ? formatPhone(athletePhone) : '';
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 p-4 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg transition-transform hover:scale-105 z-50 flex items-center justify-center"
      >
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[350px] h-[500px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden">
      <div className="flex items-center justify-between p-4 bg-green-500 text-white">
        ...
        <button onClick={() => setIsOpen(false)} className="text-white hover:bg-green-600 p-1 rounded-md transition-colors">
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      <div className="p-3 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex items-center gap-2">
        ...
        <Button
          ...
          size="icon"
          className="rounded-full bg-green-500 hover:bg-green-600 text-white w-10 h-10 shrink-0"
        >
