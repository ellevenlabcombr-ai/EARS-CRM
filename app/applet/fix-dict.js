...
const newPrompt = `      const prompt = \`
        ...
        Escreva no formato detalhado abaixo, sem introduções genéricas:
...
// Let's replace the whole prompt block. We need to be careful with the exact match, so let's use another script or string search.
