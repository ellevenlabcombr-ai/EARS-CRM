const fs = require('fs');
let code = fs.readFileSync('components/AnthropometricAssessmentForm.tsx', 'utf8');

const replacement = `  const formSteps = [
...
if (startIdx !== -1) {
  ...
  fs.writeFileSync('components/AnthropometricAssessmentForm.tsx', code);
  console.log("Success");
} else {
